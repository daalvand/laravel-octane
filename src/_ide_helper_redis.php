...
namespace Illuminate\Support\Facades {
     ...
     * @method static array  hmget($key, ...$fields)
     * @method static mixed  hmset($key, ...$dictionary)
     ...
     * @method static array  lrange($key, int $start, int $stop)
     * @method static int    lrem($key, $count, $value)
     * @method static mixed  lset($key, $index, $value)
     * @method static mixed  ltrim($key, int $start, int $stop)
     ...
     * @method static int    zadd(string $key, int|float $score, mixed $member, ...$pairs)
     * @method static int    zcard($key)
     * @method static string zcount($key, int $min, int $max)
     ...
     * @method static array  zrange($key, int $start, int $stop, array $options = null)
     * @method static array  zrangebyscore($key, int $min, int $max, array $options = null)
     * @method static int    zrank($key, $member)
     * @method static int    zrem($key, $member)
     * @method static int    zremrangebyrank($key, int $start, int $stop)
     * @method static int    zremrangebyscore($key, int $min, int $max)
     * @method static array  zrevrange($key, int $start, int $stop, array $options = null)
     ...
     * @method static array  zrangebylex($key, int $start, int $stop, array $options = null)
     * @method static array  zrevrangebylex($key, int $start, int $stop, array $options = null)
     * @method static int    zremrangebylex($key, int $min, int $max)
     * @method static int    zlexcount($key, int $min, int $max)
     * @method static array  zPopMin(string $key, int $count = 1)
     * @method static array  zPopMax(string $key, int $count = 1)
     * @method static mixed  bzpopmax($key, $timeoutOrKey, ...$extraArgs)
     * @method static mixed  bzpopmin($key, $timeoutOrKey, ...$extraArgs)
     ...
     * @method static array  pipeline($closure)
     ...
     * @method static Connection resolve(string $name = null)
