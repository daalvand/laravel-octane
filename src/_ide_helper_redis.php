...
namespace Illuminate\Support\Facades {
     ...
     * @method static bool   hexists($key, $field)
     ...
     * @method static mixed  hmset($key, ...$pairs)
     ...
     * @method static int    zadd($key, $score, $member, ...$pairs)
     ...
     * @method static array  zrange($key, $start, $end, $scores = false)
     * @method static array  zrangebyscore($key, $start, $end, $scores = false)
     ...
     * @method static array  zpopmin($key, int $count = 1)
     * @method static array  zpopmax($key, int $count = 1)
     ...
     * @method static mixed  eval($script, int $numkeys, ...$keys, ...$values)
     * @method static mixed  evalsha($script, int $numkeys, ...$keys, ...$values)
     ...
     * @method static mixed  pubsub($subcommand, ...$args)
     * @method static mixed  punsubscribe(...$patterns)
     * @method static mixed  subscribe(array $channels, $callback)
     * @method static mixed  unsubscribe(...$channels)
